...
/*----------------------------------
| Public JSON API for Landing Page
|-----------------------------------
*/
$route['api/announcements'] 		= 'public_api/announcements';
$route['api/agenda'] 				= 'public_api/agenda';
$route['api/services'] 			= 'public_api/services';
$route['api/finance'] 				= 'public_api/finance';

/*----------------------------------
| Admin: Pengumuman & Layanan
|-----------------------------------
*/
$route['pengumuman']               = 'pengumuman/index';
$route['tambah-pengumuman']        = 'pengumuman/tambah';
$route['edit-pengumuman']          = 'pengumuman/edit';
$route['hapus-pengumuman']         = 'pengumuman/hapus';

$route['layanan']                  = 'layanan/index';
$route['tambah-layanan']           = 'layanan/tambah';
$route['edit-layanan']             = 'layanan/edit';
$route['hapus-layanan']            = 'layanan/hapus';
